...
This project is a Cloudflare Worker written in TypeScript that functions as a LINE Messaging API bot. It uses Google's Gemini API (specifically the `gemini-3.1-flash-lite-preview` model) to act as a friendly and helpful assistant named "เลขาคิม".
